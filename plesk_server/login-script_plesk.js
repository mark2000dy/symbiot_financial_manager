// ====================================================
// SCRIPT DE LOGIN - SYMBIOT FINANCIAL MANAGER
// Archivo: public/assets/login-script.js
...
document.getElementById('loginForm').addEventListener('submit', async function(e) {
    ...
    try {
        // 🔥 CORREGIDO: URL correcta para el proyecto actual
        ...
        if (data.success) {
            // Guardar email si "recordarme" esta marcado
            if (rememberMe) {
        ...
        // Resetear boton
        loginBtn.innerHTML = '<i class="fas fa-sign-in-alt me-2"></i>Iniciar Sesion';
